...
- Harness/harness-skills：官方仓库、Apache-2.0 根许可证、明确说明兼容 OpenAI Codex，55 个允许目录在固定提交下均为 Markdown/参考文档且依赖 Harness MCP v2。本轮将 52 个封装为 Codex 插件；3 个存在跨 Skill 相对引用，暂缓到依赖图契约落地。
