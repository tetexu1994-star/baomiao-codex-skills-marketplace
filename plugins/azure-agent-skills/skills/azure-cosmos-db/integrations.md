# Azure Cosmos DB — Integrations & Coding Patterns
...
| Delete Cosmos DB Cassandra data using Spark | https://learn.microsoft.com/en-us/azure/cosmos-db/cassandra/spark-delete-operation |
...
| .NET Core SDK v2 reference and lifecycle for Cosmos DB | https://learn.microsoft.com/en-us/azure/cosmos-db/sdk-dotnet-core-v2 |
| .NET SDK v2 reference and lifecycle for Cosmos DB | https://learn.microsoft.com/en-us/azure/cosmos-db/sdk-dotnet-v2 |
...
| Async Java SDK v2 reference and lifecycle for Cosmos DB | https://learn.microsoft.com/en-us/azure/cosmos-db/sdk-java-async-v2 |
| Bulk Executor Java SDK reference for Cosmos DB | https://learn.microsoft.com/en-us/azure/cosmos-db/sdk-java-bulk-executor-v2 |
